...
class LSTM_3(nn.Module):
    def __init__(self, input_size, output_size, channels_1, channels_2):
        ...
        self.rnn_1 = nn.LSTM(input_size=input_size, hidden_size=channels_1, batch_first=True, num_layers = 1)
        self.rnn_2 = nn.LSTM(input_size=channels_1, hidden_size=channels_2, batch_first=True, num_layers = 1)
